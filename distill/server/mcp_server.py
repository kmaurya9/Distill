...
from distill.indexing.graph_builder import GraphBuilder, GraphNode
...
def build_server(repo_path: Path) -> MCPServer:
    """Index `repo_path` and return an MCPServer exposing search_code /
    ...
    retrieval_index.build(nodes, edges, repo_path)
